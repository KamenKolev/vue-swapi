...
<template>
	<main
		class="relative flex h-screen w-screen flex-col items-center justify-items-center gap-4 overflow-hidden bg-white p-4 text-black dark:bg-black dark:text-white"
	>
		<input
			type="text"
